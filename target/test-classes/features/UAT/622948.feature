...
@UAT
Feature: 622948 - Mass Transfer: Passenger THRU GUA-SJO with Current Option and OffPoint SJO

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 622948 - Mass Transfer: Passenger THRU GUA-SJO with Current Option and OffPoint SJO
