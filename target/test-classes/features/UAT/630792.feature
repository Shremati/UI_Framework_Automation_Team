...
#| 1               | POS:  FLL-ATO  /  USD                                                                                                                                                   |
#|                 |                                                                                                                                                                         |
#| 2               | PNR: 1 ADT  /  Prefer Presidential  /   FLL-SJO  /  Any date  /  OW   /  Economy Full                                                                                   |
#|                 |                                                                                                                                                                         |
...
@UAT
Feature: 630792 - EQP-027 Validation of baggage calculation according to "ConnectMiles Presidential" status and "Economy Full" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630792 - EQP-027 Validation of baggage calculation according to "ConnectMiles Presidential" status and "Economy Full" fare
...
#GUI
    ...
    Examples:
      ...
      |FLL ATO    |USD      |FLL          |SJO         |01 days  |0    |0    |0  |0  |1   |1         |2         |3         |4         |5         |CHECKED-IN  |32           |35            |CASH       |Economy    |Name      |PNR        |0           |DOUBLE NATIONALITY|Economy Full |US-5CD4377SFF|PrintReady   |
