#Description:
#POS: POS: BOG-ATO / COP
 #EQP-003 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy full" fare


@UAT
Feature: 630723 - EQP-003 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy full" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630723 - EQP-003 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy full" fare
...
#GUI
    ...
    Examples:
      |salesOffice     |currency |OriginCity   |Destination |StartDate  |SegmentIndex1|Adult|Child|INF|INS|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|BaggageWeight|BaggageWeight1|BaggageWeight2|PaymentType|originClass|searchType|Printer      |PrinterStatus|
      |BOG ATO         |COP      |BOG          |PTY         |01 days    |0            |1    |0    |0  |0  |1         |2         |3         |4         |23           |32            |35            |CASH       |Economy    |Name      |IN-5CD4316MPJ  |PrintReady   |
