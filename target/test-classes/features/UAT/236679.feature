#Description :
#Open Gate module
#Display List - Reconcile passengers


@UAT
Feature: 236679 - Display List - Reconcile passengers

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 236679 - Display List - Reconcile passengers
    ...
    Examples:
      |salesOffice |currency |OriginCity |Destination |StartDate |Adult |Child |INF |INS |originClass |SegmentIndex |PaymentType |printer    |printerStatus|ActionType                    |
      |PTY ATO     |USD      |PTY        |SCL         |01 days   |1     |0     |0   |0   |Economy     |0            |Cash        |IN-PF2ST1T4|PrintReady   |View/Assign Controlling Agents|
