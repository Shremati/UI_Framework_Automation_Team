#Description:
#POS: VVI-ATO / USD
#PNR: 1 ADT + 1 CHD / ADT with Prefer Presidential / VVI-BOG / Any date / OW / Economy Classic
...
#
#1. Free
#2. 200 usd (additional bag) + 100 usd (overweight) + tax
#3. 200 usd (additional bag) + 200 usd (overweight) + 150 usd (oversize) + tax
#4. 200 usd (additional bag)

@UAT
Feature: 630791 - EQP-026 Validation of baggage calculation according to "ConnectMiles Presidential" status and "Economy Classic" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630791 - EQP-026 Validation of baggage calculation according to "ConnectMiles Presidential" status and "Economy Classic" fare
...
#GUI
    ...
    Examples:
      |salesOffice|currency |OriginCity   |Destination |StartDate|Adult|Child|INF|INS|FQTV|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|BaggageNo4|ticketStatus|BaggageWeight|BaggageWeight1|BaggageWeight2|PaymentType|originClass|searchType|segmentIndex|reason            |PricingOption  |printer      |printerStatus|PaxType|PaxType1|
      |VVI ATO    |USD      |VVI          |BOG         |01 days  |0    |1    |0  |0  |1   |1         |2         |3         |4         |5         |CHECKED-IN  |32           |35            |23            |CASH       |Economy    |PNR       |0           |DOUBLE NATIONALITY|Economy Classic|IN-5CD4316MPJ|PrintReady   |FQTV   |Child   |
