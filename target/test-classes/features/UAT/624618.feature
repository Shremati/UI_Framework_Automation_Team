...
#    And I validate Ticket and EMD values in Agent sales report
    ...
    Examples:
      |salesOffice   |currency|OriginCity  |Destination  |StartDate|StartDate1|Adult|Child|INF|INS|PaymentType|COS|Airline|NRSA|pnrType|POS  |SegmentIndex|ticketStatus|ticketStatus1|
      |PTY ATO       |USD     |PTY         |MEX          |05 Days  |07 Days   |0    |0    |0  |0  |AMEX       |Y  |CM     |1   |NRSA   |PTY  |0           |Open        |EXCHD IRR    |
