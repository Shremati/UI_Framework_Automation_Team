#Description:
#EQP-017 Validation of baggage calculation according to "ConnectMiles Gold" status and "Business Promo" fare


@UAT
Feature: 630770 - EQP-017 Validation of baggage calculation according to "ConnectMiles Gold" status and "Business Promo" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630770 - EQP-017 Validation of baggage calculation according to "ConnectMiles Gold" status and "Business Promo" fare
...
#GUI
    ...
    Examples:
      |salesOffice     |currency |OriginCity   |Destination |StartDate    |ReturnDate  |SegmentIndex|Adult|Child|INF|INS|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|BaggageNo4|BaggageWeight|BaggageWeight1|BaggageWeight2|BaggageWeight3|BaggageWeight4|PaymentType|originClass|searchType|ticketStatus|PricingOption |Printer        |PrinterStatus|FQTV|
      |MAO ATO         |BRL      |MAO          |MIA         |01 Days      |03 Days     |0           |0    |0    |0  |0  |1         |2         |3         |4         |5         |32           |32            |32            |32            |35            |CASH       |Business   |Name      |CHECKED-IN  |Business Promo|IN-5CD4316MPJ  |PrintReady   |1  |
