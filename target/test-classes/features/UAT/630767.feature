...
@UAT
Feature: 630767 - EQP-014 Validation of baggage calculation according to "ConnectMiles Gold" status and "Economy Classic" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630767 - EQP-014 Validation of baggage calculation according to "ConnectMiles Gold" status and "Economy Classic" fare
    #GUI
