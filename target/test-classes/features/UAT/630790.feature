...
#| 1               | POS: SCL-ATO  /  USD                                                                                                                                                    |
#|                 |                                                                                                                                                                         |
#| 2               | PNR: 1 ADT  /  Prefer Presidential  /   SCL-HAV  /  Any date  /  OW   /  Economy Basic                                                                                  |
#|                 |                                                                                                                                                                         |
...
@UAT
Feature: 630790 - EQP-025 Validation of baggage calculation according to "ConnectMiles Presidential" status and "Economy Basic" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630790 - EQP-025 Validation of baggage calculation according to "ConnectMiles Presidential" status and "Economy Basic" fare
...
#GUI
    ...
    Examples:
      |salesOffice     |currency |OriginCity   |Destination|StartDate  |Adult|Child|INF|INS|FQTV|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|BaggageNo4|ticketStatus|BaggageWeight|BaggageWeight2|BaggageWeight1|PaymentType|originClass|reason            |searchType|searchType1|segmentIndex|PricingOption|printer      |printerStatus|
      |SCL ATO         |USD      |SCL          |HAV        |01 days    |0    |0    |0  |0  |1   |1         |2         |3         |4         |5         |CHECKED-IN  |23           |32            |35            |CASH       |Economy    |DOUBLE NATIONALITY|Name      |PNR        |0           |Economy Basic|US-5CD4377SFF|PrintReady   |
