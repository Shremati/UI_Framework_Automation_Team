...
@UAT
Feature: 630766 - EQP-013 Validation of baggage calculation according to "ConnectMiles Gold" status and "Economy Basic" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630766 - EQP-013 Validation of baggage calculation according to "ConnectMiles Gold" status and "Economy Basic" fare
