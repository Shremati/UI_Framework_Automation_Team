#Description:
#POS: PTY-ATO / USD
#EQP-016 Validation of baggage calculation according to "With ConnectMiles Gold" status and "Economy Classic Flex" fare


@UAT
Feature: 630769 - EQP-016 Validation of baggage calculation according to "With ConnectMiles Gold" status and "Economy Classic Flex" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630769 - EQP-016 Validation of baggage calculation according to "With ConnectMiles Gold" status and "Economy Classic Flex" fare
...
#GUI
    ...
    Examples:
      |salesOffice     |currency |OriginCity   |Destination |StartDate  |SegmentIndex1|Adult|Child|INF|INS|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|BaggageNo4|BaggageWeight|BaggageWeight1|BaggageWeight2|BaggageWeight3|BaggageWeight4|PaymentType|originClass|searchType|ticketStatus|FQTV|Printer      |PrinterStatus|
      |PTY ATO         |USD      |PTY          |GIG         |01 days    |0            |0    |0    |0  |0  |1         |2         |3         |4         |5         |23           |32            |35            |23            |23            |CASH       |Economy    |Name      |CHECKED-IN  |1   |IN-5CD4316MPJ|  PrintReady   |
