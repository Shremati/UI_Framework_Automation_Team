...
@UAT
Feature: 630722 - EQP-002 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy Classic" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630722 - EQP-002 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy Classic" fare
