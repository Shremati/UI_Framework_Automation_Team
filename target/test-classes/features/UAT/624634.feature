#Description:
#1.Create a PNR in POS PTY-ATO, 2ADT, 1 CHD
##Route: PTYMDZ RT / Economy Classic / USD
##Process the payment in Cash
##Add seats with cost (5,6,7, ABC) for all passengers
#Make a Change for all itinerary to leave 2 month later
# Make a voluntary reissue to leave 2 days later
##save Quote ID
...
@Reissue
Feature: 624634 - voluntary reissue in the same class when seats are paid

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 624634 - voluntary reissue in the same class when seats are paid
    ...
    Examples:
      | salesOffice | currency | OriginCity | Destination | StartDate | returnDate | StartDate1 | returnDate1 | Adult | Child | INF | INS | PaymentType | PaymentType1 | originClass | PaymentType2 | PricingOption   |PaymentType3  |
      | PTY ATO     | USD      | PTY        | MIA         | 02 Days   | 04 Days    | 56 Days    | 58 days     | 2     | 1     | 0   | 0   | Cash        | VISA         | Economy     | EMD          | EConomy Classic |CASH_AFTER_EMD|