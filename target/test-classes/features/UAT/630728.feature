...
@UAT
Feature: 630728 - EQP-008 Validation of baggage calculation according to "ConnectMiles Silver" status and "Economy Classic" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630728 - EQP-008 Validation of baggage calculation according to "ConnectMiles Silver" status and "Economy Classic" fare
