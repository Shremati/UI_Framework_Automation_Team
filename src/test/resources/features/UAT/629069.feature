...
Feature: 629069 - Mass Transfer flight infrequently every day and Icoupon compensation
  ...
  Scenario Outline: 629069 - Mass Transfer flight infrequently every day and Icoupon compensation
    ...
    Examples:
      ...
      |PTY ATO                  |USD      |MEX          |MCO         |01 days   |1    |0    |0  |0  |Economy     |Cash       |Mass Transfer|0           |PNR       |Outbound    |DIVERSION  |accept    |1            |1         |23            |IN-PF2ST1T4  |PrintReady   |CHECKED-IN    |ADJUSTED    |baggageTransfer|All Passenger List|Delay between 2 to 3:59hrs|Print List    |
