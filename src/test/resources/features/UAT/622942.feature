...
@UAT
Feature: 622942 - Mass Transfer for ADT
  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 622942 - Mass Transfer for ADT
    ...
    Examples:
      ...
      |MEX ATO                  |USD      |MEX  |MEX          |MDE         |PTY         |01 days   |02 Days    |1    |0    |0  |0  |Economy     |1  |Cash       |Mass Transfer|0           |PNR       |Outbound    |DELAY     |accept    |1            |1         |30            |IN-PF2ST1T4|PrintReady   |CHECKED-IN    |ADJUSTED    |baggageTransfer|
