#Description:
#POS: PTY-ATO / USD
 #Validation of baggage calculation according to "Without ConnectMiles" status and "Economy Basic" fare


@UAT
Feature: 630721 - EQP-001 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy Basic" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630721 - EQP-001 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy Basic" fare
...
#GUI
    ...
    Examples:
      |salesOffice     |currency |OriginCity   |Destination |StartDate  |SegmentIndex1|Adult|Child|INF|INS|BaggageNo |BaggageNo1|BaggageNo2|BaggageWeight|BaggageWeight1|BaggageWeight2|PaymentType|originClass|searchType|Printer      |PrinterStatus|ticketStatus   |
      |PTY ATO         |USD      |PTY          |BOG         |01 days    |0            |1    |0    |0  |0  |1         |2         |3         |23           |32            |35            |CASH       |Economy    |Name      |IN-5CD4316MPJ|PrintReady   |CHECKED-IN     |
