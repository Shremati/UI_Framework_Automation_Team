...
#POS: POS: BOG-ATO / COP
  ...
  @UAT
  Feature: 630786 - EQP-021 Validation of baggage calculation according to "ConnectMiles Platinum" status and "Economy Full" fare

    Background:
      Given COPA GUI Application is launched in the browser

    Scenario Outline: 630786 - EQP-021 Validation of baggage calculation according to "ConnectMiles Platinum" status and "Economy Full" fare
...
#GUI
      ...
      Examples:
        |salesOffice     |currency |OriginCity   |Destination |StartDate  |Adult|Child|INF|INS|FQTV|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|BaggageNo4|ticketStatus|BaggageWeight|BaggageWeight1|PaymentType|originClass|searchType|segmentIndex|PricingOption|reason            |printer      |printerStatus|
        |SJO ATO         |CRC      |SJO          |CUC         |01 days    |0    |0    |0  |0  |1   |1         |2         |3         |4         |5         |CHECKED-IN  |32           |35            |CASH       |Economy    |Name      |0           |Economy Full |DOUBLE NATIONALITY|US-5CD4377SFF|PrintReady   |
