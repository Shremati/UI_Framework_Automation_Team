...
Feature: 624617 - Involuntary reissue in the same class when seats are paid
  ...
  Scenario Outline: 624617 - Involuntary reissue in the same class when seats are paid
    ...
    And I make the third payment by selecting the payment type as "<PaymentType1>"
    And I enter the details in the email recipients page
    And I validate if the payment is successful
    And I click the Tickets tab
    ...
    Examples:
      |salesOffice               |currency|OriginCity  |Destination  |Destination1|OriginCity2|Destination2|StartDate|returnDate|StartDate1|returnDate1|Adult|Child|INF|INS|PaymentType|originClass|ReturnClass|NewDate1|NewDate2|NewDate3|NewDate4|PaymentType1|PricingOption  |SegmentNo|TicketStatus|
      |PTY ATO                   |USD     |PTY         |MDZ          |EZE         |MDZ        |PTY         |05 Days  |06 Days   |08 Days   |09 days    |2    |1    |0  |0  |Cash       |Economy    |Economy    |22 days |24 days |64 days |65 days |EMD        |Economy Classic|34       |EXCHANGED   |