  ...
  Scenario Outline: 624606 - Verify the system should process the change correctly by performing Involuntary Reissue by booking new segments
   ...
   #GUI
    ...
    Examples:
      ...
      | DML CALL CENTER PANAMA | USD      | PTY        | MIA         | 31 days    | 27 days    | 06 days   | 13 days    | MASTERCARD  | 3     | 0     | 0   | 0   | Economy     | Economy Classic Flex | 12      | EXCHD IRR    | WPEN IRROP-SC | Involuntary       | 1          | 1             |
