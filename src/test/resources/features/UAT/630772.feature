...
#GUI
    ...
    Examples:
      |salesOffice     |currency |OriginCity   |Destination  |StartDate  |StartDate1  |SegmentIndex|Adult|Child|INF|INS|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|BaggageNo4|BaggageWeight|BaggageWeight1|BaggageWeight2|BaggageWeight3|BaggageWeight4|PaymentType|originClass|searchType|SegmentIndex1|ticketStatus|Printer      |PrinterStatus|searchType1|FQTV|
      |YUL ATO         |CAD      |YUL          |CTG          |02 days    |02 days     |0           |0    |0    |0  |0  |1         |2         |3         |4         |5         |23           |23            |32            |35            |23            |CASH       |Economy    |Name      |1            |CHECKED-IN  |IN-5CD4316MPJ|PrintReady   |Name       |1   |
