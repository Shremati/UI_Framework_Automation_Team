...
@UAT
Feature: 630724 - EQP-004 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy Classic Flex" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630724 - EQP-004 Validation of baggage calculation according to "Without ConnectMiles" status and "Economy Classic Flex" fare
