#Description:
#Create a new order for 4 ADT with classic fare family and reissue ticket to a new route with new dates.
#
...
Feature: 624656 - New order in Call Center Panama (USD) and reissue ticket (JE)
  ...
  Scenario Outline: 624656 - New order in Call Center Panama (USD) and reissue ticket (JE)
