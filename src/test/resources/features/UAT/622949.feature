...
@UAT
Feature: 622949 - Mass Transfer: Passenger THRU Routing GUA-SJO-PTY with Current Option and OffPoint PTY

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 622949 - Mass Transfer: Passenger THRU Routing GUA-SJO-PTY with Current Option and OffPoint PTY
