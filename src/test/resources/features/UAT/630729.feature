...
Feature: 630729 - EQP-009 Validation of baggage calculation according to "ConnectMiles Silver" status and "Economy full" fare
  ...
  Scenario Outline: 630729 - EQP-009 Validation of baggage calculation according to "ConnectMiles Silver" status and "Economy full" fare
    ...
    Examples:
      |salesOffice              |currency |OriginCity   |Destination |StartDate |Adult|Child|INF|INS|FQTV|originClass |PaymentType|SegmentIndex1|SegmentIndex2|BaggageNo |BaggageNo1|BaggageNo2|BaggageWeight|BaggageWeight1|BaggageWeight2|BaggageNo3|BaggageWeight3|searchType|ticketStatus|printer      |printerStatus|
      |BOS ATO                  |USD      |BOS          |SCL         |01 days   |0    |0    |0  |0  |1   |Economy     |Cash       |0            |1            |1         |2         |3         |32           |32            |32            |4         |35            |Name      |CHECKED-IN  |IN-PF2ST1T4  |PrintReady   |
