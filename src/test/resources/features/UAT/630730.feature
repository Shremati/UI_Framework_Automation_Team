...
@UAT
Feature: 630730 - EQP-010 Validation of baggage calculation according to "ConnectMiles Silver" status and "Economy Classic Flex" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630730 - EQP-010 Validation of baggage calculation according to "ConnectMiles Silver" status and "Economy Classic Flex" fare
