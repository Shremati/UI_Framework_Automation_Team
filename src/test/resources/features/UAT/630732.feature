##Description:
##POS: COR-ATO / ARS
#PNR: 1 ADT / Prefer Silver / COR-SJO / Any date / OW / Business Full
...
@UAT
Feature: 630732 - EQP-012 Validation of baggage calculation according to "ConnectMiles Silver" status and "Business Full" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630732 - EQP-012 Validation of baggage calculation according to "ConnectMiles Silver" status and "Business Full" fare
...
#    And I validate EMD values in Agent Sales Report
    ...
    Examples:
      |salesOffice     |currency |OriginCity   |Destination1 |StartDate  |SegmentIndex1|Adult|Child|INF|INS|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|BaggageWeight|BaggageWeight1|BaggageWeight2|BaggageWeight3|PaymentType|originClass|searchType|FQTV|ticketStatus|PricingOption |Printer      |PrinterStatus|documentType|
      |COR ATO         |ARS      |COR          |SJO          |02 days    |0            |0    |0    |0  |0  |1         |2         |3         |4         |32           |32            |32            |35            |CASH       |Business   |Name      |1   |CHECKED-IN  |Business Full |IN-5CD4316MPJ|PrintReady   |Passport    |
