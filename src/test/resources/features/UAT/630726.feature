...
@UAT
Feature: 630726 - EQP-006 Validation of baggage calculation according to "without ConnectMiles" status and "Business Full" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630726 - EQP-006 Validation of baggage calculation according to "without ConnectMiles" status and "Business Full" fare
