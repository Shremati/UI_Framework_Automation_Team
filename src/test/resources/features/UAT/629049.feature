...
@UAT
Feature: 629049 - Added SSR should be displayed in the final report of the selected flight

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 629049 - Added SSR should be displayed in the final report of the selected flight
