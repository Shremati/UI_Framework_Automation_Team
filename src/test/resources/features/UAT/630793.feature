...
@UAT
Feature: 630793 - EQP-028 Validation of baggage calculation according to "ConnectMiles Presidential" status and "Economy Classic Flex" fare

  Background:
    Given COPA GUI Application is launched in the browser

  Scenario Outline: 630793 - EQP-028 Validation of baggage calculation according to "ConnectMiles Presidential" status and "Economy Classic Flex" fare
...
#GUI
    ...
    Examples:
      |salesOffice|currency |OriginCity   |Destination |StartDate|ReturnDate|Adult|Child|INF|INS|FQTV|BaggageNo |BaggageNo1|BaggageNo2|BaggageNo3|ticketStatus|BaggageWeight|BaggageWeight1|BaggageWeight2|PaymentType|originClass|ReturnClass|searchType|searchType1|segmentIndex|reason            |PricingOption       |printer      |printerStatus|
      |GIG ATO    |BRL      |MAO          |SJO         |01 days  |02 days   |0    |0    |0  |0  |1   |1         |2         |3         |4         |CHECKED-IN  |32           |35            |23            |CASH       |Economy    |Economy    |Name      |PNR        |0           |DOUBLE NATIONALITY|Economy Classic Flex|US-5CD4377SFF|PrintReady   |
